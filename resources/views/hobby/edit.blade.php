                ...
                <div class="card-body">
                    <form autocomplete="off" action="/hobby/{{ $hobby->id}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea
                                class="form-control {{ $errors->has('beschreibung') ? 'border-danger' : '' }}"
                                id="beschreibung" name="beschreibung"
                                rows="5">{{ old('beschreibung') ?? $hobby->beschreibung }}</textarea>
                    ...
                    <a class="btn btn-primary btn-sm mt-3 float-right" href="/hobby"><i
